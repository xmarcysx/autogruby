                    ...
                    <tr key={car.id} className="hover:bg-sky-50/50 transition-colors group">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex flex-col gap-1">
                          {car.sold ? (
                            <Badge className="bg-brand-gold/10 text-brand-gold-dark border-brand-gold/20 text-xs w-fit">
                              Sprzedany
                            </Badge>
                          ) : (
                            <Badge className="bg-emerald-50 text-emerald-700 border-emerald-200 text-xs w-fit">
                              Aktywny
                            </Badge>
                          )}
                          {!car.published && (
